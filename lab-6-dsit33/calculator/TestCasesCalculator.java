...
public class TestCasesCalculator
{
   ...
   @Test
   public void test05_DivideExpressionEvaluate()
   {
      IdentifierExpression x = new IdentifierExpression("x");
      IdentifierExpression y = new IdentifierExpression("y");
   ...
   @Test
   public void test06_DivideExpressionToString()
   {
      IdentifierExpression x = new IdentifierExpression("x");
      IdentifierExpression y = new IdentifierExpression("y");
      DivideExpression div = new DivideExpression(x, y);
   ...
   @Test
   public void test07_MultiplyExpressionEvaluate()
   {
      IdentifierExpression x = new IdentifierExpression("x");
      IdentifierExpression y = new IdentifierExpression("y");
      MultiplyExpression add = new MultiplyExpression(x, y);

      assertEquals(25.0, add.evaluate(bindings), DELTA);
   }

   @Test
   public void test08_MultiplyExpressionToString()
   {
      IdentifierExpression x = new IdentifierExpression("x");
      IdentifierExpression y = new IdentifierExpression("y");
