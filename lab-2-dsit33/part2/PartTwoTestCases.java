...
public class PartTwoTestCases
{
   ...
   public void testPerimeter(){
      ...
      assertEquals(6*Math.PI, c.perimeter(), DELTA);
      assertEquals(16.0, r.perimeter(), DELTA);
      assertEquals(20.0, p.perimeter(), DELTA);
   }
   ...
   public void testBigger(){
      ...
      assertEquals(p.perimeter(), Bigger.whichIsBigger(c, r, p), DELTA);
   }
